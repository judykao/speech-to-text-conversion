...
# plt.plot(tasks, origin, label='Adjusted', color='orange', marker='o', linestyle='-.', markersize=6)
...
# plt.legend()
# plt.tight_layout()
# plt.savefig('plot/test_compare.png')
...
# plot_spec('Tasks/Task_3_Level_1/Recorded/task_3_level_1_recorded_001.wav', 'T3_recorded')
# plot_spec('Dataset/Task_3_Level_1/pred_audio/task_3_level_1_recorded_001.wav', 'T3_adjusted', n=211680)
